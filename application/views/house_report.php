        ...
        <div class="page-content-wrapper"><!-- BEGIN CONTENT BODY -->
			<div class="page-content" style="min-height:1434px"><!-- BEGIN CONTENT BODY -->
				<div class="app-content-body ">
					<!-- BEGIN PAGE HEADER-->
						<h3 class="page-title">House Reports	<br><small>Search &amp; Call detail report</small></h3>
							...
							<div class="col-md-12">
								<div class="portlet light">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-bar-chart"></i>House Reports 
										</div>
									<div class="portlet-body">						
									    ...
									    <tbody>
									        ...
									        <tr>
									            ...
									            <td><?php echo $values['callerid']; ?></td>
									            <td></td>
									            <td><?php echo $values['FullCallLength']; ?></td>

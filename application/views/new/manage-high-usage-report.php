            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">High Usage Report
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                            <thead>
                                 <tr>
                                    ...
                                    <th>Student Name</th>
                                    <th>Roll No</th>
                                    <th>Total No. Of Calls Made</th>
                                    <th>Total Usage In Minutes</th>
                                    <th>Last Call Made On (Date)</th>        
                                </tr>
                            </thead>
                              ...
                              <?php if(!empty($reportDetails)) { ?>
                                ...
                                <?php $i = 1; foreach($reportDetails as $row) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row['total_usage_minutes']; ?> Min
                                        </td>

                                        <td>
                                            <?php 
                                                echo !empty($row['last_call_date']) 

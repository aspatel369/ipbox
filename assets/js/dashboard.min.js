var Dashboard=function() {
    return {
        ...
        initSparklineCharts:function() {
			$.ajax({                                      
			url: 'assets/js/sparkline.php',  //the script to call to get data          
			dataType: 'json',                //data format      
			success: function(data)          //on recieve of reply
				{
				jQuery().sparkline&&($("#sparkline_bar").sparkline(data, {
				type: "bar", width: "100", barWidth: 6, height: "55", barColor: "#35aa47", negBarColor: "#e02222"}
				))
				} 
			}), 
			...
			$.ajax({                                      
			url: 'assets/js/callsprocessed.php',  //the script to call to get data          
			dataType: 'json',                //data format      
			success: function(data)          //on recieve of reply
				{
				jQuery().sparkline&&($("#sparkline_bar5").sparkline(data, {
				type: "bar", width: "100", barWidth: 6, height: "55", barColor: "#35aa47", negBarColor: "#e02222"}
				))
				} 
			}),
